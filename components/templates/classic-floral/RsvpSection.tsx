    ...
    switch (activeSlug) {
      ...
      case "veridian-garden":
        return {
          ...
          subtitleColor: "text-[#819986]",
          titleColor: "text-white font-serif font-bold",
          textColor: "text-[#819986]",
      ...
      case "photo-gallery":
        return {
          ...
          cardStyle: "bg-white/90 backdrop-blur-xl border border-[#D4AF37]/40 rounded-2xl p-8 sm:p-12 shadow-2xl relative text-[#1b1c19]",
          subtitleColor: "text-[#4a4452]",
          titleColor: "text-[#31105C] font-serif font-bold",
      ...
      case "mint-slate":
        return {
          ...
          subtitleColor: "text-[#246a52]",
          titleColor: "text-[#191c1d] font-mono font-bold uppercase",
      ...
      case "jade-ink":
        return {
          ...
          subtitleColor: "text-[#006d43]",
          titleColor: "text-[#191c1d] font-serif font-bold",
          textColor: "text-[#191c1d]",
