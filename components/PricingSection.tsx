...
export default function PricingSection() {
  const plans = [
    ...
    },
    {
      ...
      price: "₹2000",
      period: "1 Full Year",
      desc: "Exclusive 480-Frame Apple-Style Video Scroll invitation + All Standard Templates.",
      popular: false,
      isCinematic: true,
      buttonText: "Choose Cinematic (₹2000)",
      buttonLink: "/checkout?plan=CINEMATIC_2000",
      features: [
        "Includes Exclusive 480-Frame Scroll Template",
        "5 Total Invitation Template Slots",
