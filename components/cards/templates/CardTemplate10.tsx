  ...
  return (
    ...
    >
      ...
      <div style={{ zIndex: 10, width: '100%', padding: '0 100px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
        ...
        <p style={{ fontFamily: "'Jost', sans-serif", fontSize: '18px', letterSpacing: '8px', color: '#C87D55', textTransform: 'uppercase', marginBottom: '50px' }}>
          {tagline}
        </p>
        ...
        <div style={{ position: 'relative', width: '300px', height: '300px', marginBottom: '50px' }}>
          ...
          <div style={{
            ...
            background: 'linear-gradient(135deg, #E0986C, #73452c, #E0986C)',
            zIndex: 1,
          }} />
          <div style={{
            position: 'absolute',
        ...
        <div style={{ marginBottom: '30px' }}>
          <h1 style={{ fontSize: '70px', fontWeight: 600, color: '#E0986C', margin: 0, letterSpacing: '4px', textTransform: 'uppercase', lineHeight: 1.1 }}>
            {partnerOne}
            <br />
            <span style={{ fontSize: '40px', fontWeight: 400, color: '#C87D55', fontFamily: "'Jost', sans-serif" }}>&</span>
            <br />
            {partnerTwo}
          </h1>
        </div>
        ...
        <div style={{ fontFamily: "'Jost', sans-serif", display: 'flex', flexDirection: 'column', gap: '12px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '15px' }}>
            <span style={{ fontSize: '20px', letterSpacing: '3px', fontWeight: 500, textTransform: 'uppercase' }}>{weddingDate}</span>
            <div style={{ width: '4px', height: '4px', backgroundColor: '#C87D55', borderRadius: '50%' }}></div>
            <span style={{ fontSize: '20px', letterSpacing: '3px', fontWeight: 500 }}>{weddingTime}</span>
          </div>
          <p style={{ fontSize: '22px', margin: 0, fontWeight: 400, letterSpacing: '2px', color: '#E0986C' }}>
            {venue}
          </p>
          <p style={{ fontSize: '16px', margin: 0, fontWeight: 300, letterSpacing: '4px', textTransform: 'uppercase', color: 'rgba(224, 152, 108, 0.7)' }}>
            {city}
          </p>
        </div>

        <div style={{ marginTop: '40px' }}>
          <p style={{ fontFamily: "'Jost', sans-serif", fontSize: '18px', color: '#C87D55', fontWeight: 300, letterSpacing: '5px' }}>
            {hashtag}
          </p>
        </div>
