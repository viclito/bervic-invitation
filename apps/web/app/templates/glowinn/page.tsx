...
function GlowinnContent() {
  ...
  return (
    <div className="relative min-h-screen">
      <DynamicTemplateCard {...invitationData} isPreview={true} templateSlug="glowinn" />
      {!isThumbnail && (
        <TemplatePreviewBottomBar
          slug="glowinn"
          templateTitle="Glowinn — Made for Modern Elegance"
          isPremium={true}
          price={2000}
...
export default function GlowinnPage() {
  return (
