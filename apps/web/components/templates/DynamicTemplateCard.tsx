...
const TemplateClassicFloral = dynamic(() => import("./classic-floral/TemplateClassicFloral"));
...
const GlowinnTemplate = dynamic(() => import("./glowinn/GlowinnTemplate"));
...
export default function DynamicTemplateCard(props: DynamicTemplateCardProps) {
  ...
  if (currentSlug === "classic-floral") {
    return <TemplateClassicFloral {...props} />;
  }
  ...
  if (currentSlug === "glowinn") {
    return <GlowinnTemplate {...props} />;
  }
