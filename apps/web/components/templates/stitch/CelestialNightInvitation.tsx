          ...
          {eventsList.map((evt, idx) => (
            ...
            >
              <div>
                ...
                <p className="text-xs text-[#a3a8be] mb-4 leading-relaxed font-medium">
                  <span className="text-white font-semibold block mb-0.5">{evt.venue}</span>
                  {evt.address}
                </p>

                <div className="relative w-full h-36 rounded-lg overflow-hidden border border-[#d4af37]/30 mb-6 shadow-inner bg-[#090a10]">
                  <iframe
