  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 flex flex-col font-sans">
      ...
      <div className="flex-1 pt-20 sm:pt-24 pb-20">
        {/* Semantic SEO Hero Header for Search Engines & Visitors */}
        <header className="max-w-[1600px] w-full mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 mb-4 sm:mb-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-2 border-b border-slate-100 pb-3 sm:pb-4">
            <div>
              <div className="inline-flex items-center gap-2 px-2.5 py-0.5 rounded-full bg-amber-50 border border-amber-200/60 text-amber-800 text-[11px] font-bold mb-1.5">
                <Sparkles className="w-3 h-3 text-amber-600" />
                <span>Handcrafted Print Store • Doorstep Delivery Across India</span>
              </div>
              <h1 className="text-xl sm:text-2xl lg:text-3xl font-serif font-black text-slate-900 tracking-tight">
                Invitation Cards &amp; Traditional Wedding Print Store
              </h1>
              <p className="text-xs sm:text-sm text-slate-500 font-medium mt-1 max-w-3xl">
                Order luxury gold foil wedding invitations, traditional marriage cards, Griha Pravesh &amp; celebration invite suites printed on premium 350+ GSM textured cardstock.
              </p>
            </div>
            <div className="hidden lg:flex items-center gap-4 text-xs font-semibold text-slate-500">
              <span className="flex items-center gap-1.5"><Truck className="w-3.5 h-3.5 text-emerald-600" /> All-India Delivery</span>
              <span className="flex items-center gap-1.5"><ShieldCheck className="w-3.5 h-3.5 text-emerald-600" /> Premium Quality Assured</span>
            </div>
          </div>
        </header>
