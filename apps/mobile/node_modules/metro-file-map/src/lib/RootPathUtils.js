...
class RootPathUtils {
  ...
  #rootParts;
  #rootDepth;
  constructor(rootDir) { /* __win32_drive_normalized */ if (process.platform === "win32" && typeof rootDir === "string" && rootDir.length >= 2 && rootDir[1] === ":") { rootDir = rootDir[0].toUpperCase() + rootDir.slice(1); }
  ...
  absoluteToNormal(absolutePath) { if (process.platform === "win32" && typeof absolutePath === "string" && absolutePath.length >= 2 && absolutePath[1] === ":") { absolutePath = absolutePath[0].toUpperCase() + absolutePath.slice(1); }
  ...
  normalToAbsolute(normalPath) { if (process.platform === "win32" && typeof normalPath === "string" && normalPath.length >= 2 && normalPath[1] === ":") { normalPath = normalPath[0].toUpperCase() + normalPath.slice(1); }
  ...
  relativeToNormal(relativePath) { if (process.platform === "win32" && typeof relativePath === "string" && relativePath.length >= 2 && relativePath[1] === ":") { relativePath = relativePath[0].toUpperCase() + relativePath.slice(1); }
    return (
